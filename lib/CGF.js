...
(function() {
    ...
    (function(t) {
        ...
        d.translate = function(t, e, i) {
            var n = i[0], r = i[1], o = i[2], s, a, c, u, l, h, f, d, p, v, m, _;
            if (e === t) {
        ...
        d.rotate = function(t, i, n, r) {
            var o = r[0], s = r[1], a = r[2], c = Math.sqrt(o * o + s * s + a * a), u, l, h, f, d, p, v, m, _, g, b, y, x, w, E, A, C, M, S, T, R, k, F, L;
            if (Math.abs(c) < e) {
                return null
            }
            c = 1 / c;
        ...
        d.lookAt = function(t, i, n, r) {
            var o, s, a, c, u, l, h, f, p, v, m = i[0], _ = i[1], g = i[2], b = r[0], y = r[1], x = r[2], w = n[0], E = n[1], A = n[2];
...
!function(t, e) {
    ...
    function e(t, e) {
        ...
        if (e || "THREE_CHAR_HEX" === i || "SIX_CHAR_HEX" === i) {
            for (var l = t.hex.toString(16); l.length < 6; )
                l = "0" + l;
            return "#" + l
        }
    ...
    function i(t, e, i) {
        Object.defineProperty(t, e, {
            get: function() {
                return "RGB" === this.__state.space ? this.__state[e] : (U.recalculateRGB(this, e, i),
                this.__state[e])
            },
            set: function(t) {
                "RGB" !== this.__state.space && (U.recalculateRGB(this, e, i),
    ...
    function n(t, e) {
        Object.defineProperty(t, e, {
            get: function() {
                return "HSV" === this.__state.space ? this.__state[e] : (U.recalculateHSV(this),
                this.__state[e])
            },
            set: function(t) {
                "HSV" !== this.__state.space && (U.recalculateHSV(this),
    ...
    function h(t) {
        H.unbind(window, "resize", t.__resizeHandler),
        t.saveToLocalStorageIfPossible && H.unbind(window, "unload", t.saveToLocalStorageIfPossible)
    }
    function f(t, e) {
    ...
    function d(t, e, i) {
        ...
        i instanceof J) {
            ...
            i.min = S.compose(r, i.min),
            i.max = S.compose(r, i.max)
        } else
            i instanceof Y ? (H.bind(e, "click", function() {
            ...
            })) : i instanceof $ && (H.addClass(e, "color"),
            i.updateDisplay = S.compose(function(t) {
                return e.style.borderLeftColor = i.__color.toString(),
                t
            }, i.updateDisplay),
            i.updateDisplay());
        i.setValue = S.compose(function(e) {
            return t.getRoot().__preset_select && i.isModified() && f(t.getRoot(), !0),
            e
        }, i.setValue)
    }
    function p(t, e) {
    ...
    function v(t, e, i, n) {
        ...
        n.before instanceof N && (n.before = n.before.__li),
        p(t, r),
        H.addClass(r.domElement, "c");
        var s = document.createElement("span");
        H.addClass(s, "property-name"),
        ...
        r instanceof $ ? H.addClass(c, "color") : H.addClass(c, O(r.getValue())),
        d(t, c, r),
    ...
    function b(t) {
        ...
        H.addClass(t.domElement, "has-save"),
        t.__ul.insertBefore(e, t.__ul.firstChild),
        H.addClass(e, "save-row");
        var i = document.createElement("span");
        i.innerHTML = "&nbsp;",
        H.addClass(i, "button gears");
    ...
    function y(t) {
        ...
        function i() {
            H.removeClass(t.__closeButton, dt.CLASS_DRAG),
            H.unbind(window, "mousemove", e),
            H.unbind(window, "mouseup", i)
        }
        function n(n) {
            return n.preventDefault(),
            r = n.clientX,
            H.addClass(t.__closeButton, dt.CLASS_DRAG),
            H.bind(window, "mousemove", e),
            H.bind(window, "mouseup", i),
            !1
        }
        var r = void 0;
        ...
        H.bind(t.__resize_handle, "mousedown", n),
        H.bind(t.__closeButton, "mousedown", n),
    ...
    var C = Array.prototype.forEach
      ...
      , S = {
        ...
        compose: function() {
            ...
            return function() {
                for (var e = M.call(arguments), i = t.length - 1; i >= 0; i--)
                    e = [t[i].apply(this, e)];
                return e[0]
            }
        },
        each: function(t, e, i) {
            if (t)
                if (C && t.forEach && t.forEach === C)
                    ...
                    for (n = 0,
                    r = t.length; n < r; n++)
                        if (n in t && e.call(i, t[n], n) === this.BREAK)
                            return
                } else
                    for (var o in t)
                        if (e.call(i, t[o], o) === this.BREAK)
                            return
        },
        defer: function(t) {
            setTimeout(t, 0)
      ...
      , F = function() {
        ...
        return S.each(T, function(e) {
            if (e.litmus(t))
                return S.each(e.conversions, function(e, i) {
                    if (R = e.read(t),
                    !1 === k && !1 !== R)
                        return k = R,
                        R.conversionName = i,
      ...
      , B = {
        hsv_to_rgb: function(t, e, i) {
            var n = Math.floor(t / 60) % 6
              ...
              , s = i * (1 - r * e)
              , a = i * (1 - (1 - r) * e)
              , c = [[i, a, o], [s, i, o], [o, i, a], [o, s, i], [a, o, i], [i, o, s]][n];
            return {
                r: 255 * c[0],
                g: 255 * c[1],
                b: 255 * c[2]
        ...
        rgb_to_hsv: function(t, e, i) {
            ...
            s = t === r ? (e - i) / o : e === r ? 2 + (i - t) / o : 4 + (t - e) / o,
            (s /= 6) < 0 && (s += 1),
            {
                h: 360 * s,
                s: a,
    ...
    U.recalculateRGB = function(t, e, i) {
        if ("HEX" === t.__state.space)
            t.__state[e] = B.component_from_hex(t.__state.hex, i);
        else {
    ...
    var X = /(\d+(\.\d+)?)px/
      ...
      , Y = function(t) {
        function e(t, i) {
            ...
            H.bind(n.__checkbox, "change", function() {
                r.setValue(!r.__prev)
            }, !1),
        ...
        P(e, [{
            ...
            value: function() {
                ...
                this.__prev = !1),
                G(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
            }
        }]),
        e
    }()
      , q = function(t) {
        function e(t, i, n) {
            ...
            return S.each(o, function(t, e) {
                ...
                s.__select.appendChild(i)
            }),
            r.updateDisplay(),
            H.bind(r.__select, "change", function() {
        ...
        P(e, [{
            ...
            key: "updateDisplay",
            value: function() {
                return H.isActive(this.__select) ? this : (this.__select.value = this.getValue(),
                G(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this))
            }
        }]),
        e
      ...
      , W = function(t) {
        function e(t, i) {
            ...
            H.bind(r.__input, "keyup", n),
            H.bind(r.__input, "change", n),
            H.bind(r.__input, "blur", function() {
        ...
        P(e, [{
            key: "updateDisplay",
            value: function() {
                return H.isActive(this.__input) || (this.__input.value = this.getValue()),
                G(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
            }
        }]),
        e
      ...
      , K = function(t) {
        function e(t, i, n) {
            ...
            r.__max = s.max,
            r.__step = s.step,
            S.isUndefined(r.__step) ? 0 === r.initialValue ? r.__impliedStep = 1 : r.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(r.initialValue)) / Math.LN10)) / 10 : r.__impliedStep = r.__step,
        ...
        P(e, [{
            ...
            value: function(t) {
                ...
                G(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "setValue", this).call(this, i)
            }
        }, {
            key: "min",
            value: function(t) {
      ...
      , Q = function(t) {
        function e(t, i, n) {
            ...
            function s() {
                H.unbind(window, "mousemove", o),
                H.unbind(window, "mouseup", s),
                r()
            }
            D(this, e);
            ...
            H.bind(a.__input, "change", function() {
            ...
            H.bind(a.__input, "mousedown", function(t) {
                H.bind(window, "mousemove", o),
                H.bind(window, "mouseup", s),
                u = t.clientY
            }),
      ...
      , J = function(t) {
        function e(t, i, n, r, o) {
            function s(t) {
                ...
                return f.setValue(a(t.clientX, e.left, e.right, f.__min, f.__max)),
                !1
            }
            function c() {
                H.unbind(window, "mousemove", s),
                H.unbind(window, "mouseup", c),
            ...
            function l() {
                H.unbind(window, "touchmove", u),
                H.unbind(window, "touchend", l),
                f.__onFinishChange && f.__onFinishChange.call(f, f.getValue())
            }
            D(this, e);
            ...
            H.bind(h.__background, "mousedown", function(t) {
                document.activeElement.blur(),
                H.bind(window, "mousemove", s),
                H.bind(window, "mouseup", c),
                s(t)
            }),
            H.bind(h.__background, "touchstart", function(t) {
                1 === t.touches.length && (H.bind(window, "touchmove", u),
                H.bind(window, "touchend", l),
                u(t))
            }),
            H.addClass(h.__background, "slider"),
            H.addClass(h.__foreground, "slider-fg"),
            h.updateDisplay(),
      ...
      , Z = function(t) {
        function e(t, i, n) {
            ...
            r.__button.innerHTML = void 0 === n ? "Fire" : n,
            H.bind(r.__button, "click", function(t) {
                return t.preventDefault(),
                o.fire(),
                !1
            }),
            H.addClass(r.__button, "button"),
      ...
      , $ = function(t) {
        function e(t, i) {
            function n(t) {
                h(t),
                H.bind(window, "mousemove", h),
                H.bind(window, "touchmove", h),
                H.bind(window, "mouseup", o),
                H.bind(window, "touchend", o)
            }
            function r(t) {
                f(t),
                H.bind(window, "mousemove", f),
                H.bind(window, "touchmove", f),
                H.bind(window, "mouseup", s),
                H.bind(window, "touchend", s)
            }
            function o() {
                H.unbind(window, "mousemove", h),
                H.unbind(window, "touchmove", h),
                H.unbind(window, "mouseup", o),
                H.unbind(window, "touchend", o),
                l()
            }
            function s() {
                H.unbind(window, "mousemove", f),
                H.unbind(window, "touchmove", f),
                H.unbind(window, "mouseup", s),
                H.unbind(window, "touchend", s),
                l()
            }
            function a() {
                var t = F(this.value);
                !1 !== t ? (p.__color.__state = t,
            ...
            d.__color = new U(d.getValue()),
            d.__temp = new U(0);
            var p = d;
            d.domElement = document.createElement("div"),
            H.makeSelectable(d.domElement, !1),
            d.__selector = document.createElement("div"),
            d.__selector.className = "selector",
            d.__saturation_field = document.createElement("div"),
            d.__saturation_field.className = "saturation-field",
            d.__field_knob = document.createElement("div"),
            d.__field_knob.className = "field-knob",
            d.__field_knob_border = "2px solid ",
            d.__hue_knob = document.createElement("div"),
            d.__hue_knob.className = "hue-knob",
            d.__hue_field = document.createElement("div"),
            d.__hue_field.className = "hue-field",
            d.__input = document.createElement("input"),
            d.__input.type = "text",
            d.__input_textShadow = "0 1px 1px ",
            H.bind(d.__input, "keydown", function(t) {
                13 === t.keyCode && a.call(this)
            }),
            H.bind(d.__input, "blur", a),
            H.bind(d.__selector, "mousedown", function() {
            ...
            H.bind(d.__saturation_field, "mousedown", n),
            H.bind(d.__saturation_field, "touchstart", n),
            H.bind(d.__field_knob, "mousedown", n),
            H.bind(d.__field_knob, "touchstart", n),
            H.bind(d.__hue_field, "mousedown", r),
            H.bind(d.__hue_field, "touchstart", r),
            d.__saturation_field.appendChild(v),
            d.__selector.appendChild(d.__field_knob),
            d.__selector.appendChild(d.__saturation_field),
            d.__selector.appendChild(d.__hue_field),
            d.__hue_field.appendChild(d.__hue_knob),
            d.domElement.appendChild(d.__input),
            d.domElement.appendChild(d.__selector),
            d.updateDisplay(),
            d
        }
        return V(e, N),
            ...
            value: function() {
                ...
                if (!1 !== t) {
                    ...
                    S.each(U.COMPONENTS, function(i) {
                        if (!S.isUndefined(t[i]) && !S.isUndefined(this.__color.__state[i]) && t[i] !== this.__color.__state[i])
                            return e = !0,
                            {}
                    }, this),
      ...
      , rt = function() {
        ...
        return P(t, [{
            ...
            value: function() {
                var t = this
                  , e = function e() {
                    ...
                    H.unbind(t.domElement, "webkitTransitionEnd", e),
                    H.unbind(t.domElement, "transitionend", e),
                    H.unbind(t.domElement, "oTransitionEnd", e)
                };
                H.bind(this.domElement, "webkitTransitionEnd", e),
                H.bind(this.domElement, "transitionend", e),
                H.bind(this.domElement, "oTransitionEnd", e),
            ...
            key: "layout",
            value: function() {
                this.domElement.style.left = window.innerWidth / 2 - H.getWidth(this.domElement) / 2 + "px",
                this.domElement.style.top = window.innerHeight / 2 - H.getHeight(this.domElement) / 2 + "px"
            }
        }]),
        t
    }()
    ...
    var st = "Default"
      ...
      , dt = function t(e) {
        ...
        S.isUndefined(n.parent) && n.hideable && ft.push(this),
        n.resizable = S.isUndefined(n.parent) && n.resizable,
        n.autoPlace && S.isUndefined(n.scrollable) && (n.scrollable = !0);
        ...
        if (Object.defineProperties(this, {
            ...
            closed: {
                ...
                set: function(e) {
                    n.closed = e,
                    n.closed ? H.addClass(i.__ul, t.CLASS_CLOSED) : H.removeClass(i.__ul, t.CLASS_CLOSED),
                    this.onResize(),
            ...
            useLocalStorage: {
                ...
                set: function(t) {
                    at && (r = t,
                    t ? H.bind(window, "unload", o) : H.unbind(window, "unload", o),
                    localStorage.setItem(m(i, "isLocal"), t))
                }
            }
        }),
        S.isUndefined(n.parent)) {
            if (this.closed = n.closed || !1,
            ...
            n.closeOnTop ? (H.addClass(this.__closeButton, t.CLASS_CLOSE_TOP),
            this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0])) : (H.addClass(this.__closeButton, t.CLASS_CLOSE_BOTTOM),
            ...
            H.addClass(c, "controller-name"),
            s = l(i, c);
            H.addClass(this.__ul, t.CLASS_CLOSED),
            H.addClass(s, "title"),
            H.bind(s, "click", function(t) {
                return t.preventDefault(),
                i.closed = !i.closed,
                !1
            }),
        ...
        n.autoPlace && (S.isUndefined(n.parent) && (ut && (lt = document.createElement("div"),
        H.addClass(lt, "dg"),
        H.addClass(lt, t.CLASS_AUTO_PLACE_CONTAINER),
        document.body.appendChild(lt),
        ut = !1),
        lt.appendChild(this.domElement),
        H.addClass(this.domElement, t.CLASS_AUTO_PLACE)),
        this.parent || x(i, n.width)),
        this.__resizeHandler = function() {
            i.onResizeDebounced()
        }
        ,
        H.bind(window, "resize", this.__resizeHandler),
    ...
    dt.toggleHide = function() {
        ht = !ht,
        S.each(ft, function(t) {
            t.domElement.style.display = ht ? "none" : ""
        })
    }
    ,
    dt.CLASS_AUTO_PLACE = "a",
    dt.CLASS_AUTO_PLACE_CONTAINER = "ac",
    dt.CLASS_MAIN = "main",
    dt.CLASS_CONTROLLER_ROW = "cr",
    dt.CLASS_TOO_TALL = "taller-than-window",
    dt.CLASS_CLOSED = "closed",
    dt.CLASS_CLOSE_BUTTON = "close-button",
    dt.CLASS_CLOSE_TOP = "close-top",
    dt.CLASS_CLOSE_BOTTOM = "close-bottom",
    dt.CLASS_DRAG = "drag",
    dt.DEFAULT_WIDTH = 245,
    dt.TEXT_CLOSED = "Close Controls",
    dt.TEXT_OPEN = "Open Controls",
    dt._keydownHandler = function(t) {
        "text" === document.activeElement.type || 72 !== t.which && 72 !== t.keyCode || dt.toggleHide()
    }
    ,
    H.bind(window, "keydown", dt._keydownHandler, !1),
    S.extend(dt.prototype, {
        add: function(t, e) {
            return v(this, t, e, {
        ...
        destroy: function() {
            ...
            H.unbind(window, "keydown", dt._keydownHandler, !1),
            h(this)
        },
        ...
        onResize: function() {
            ...
            if (t.scrollable) {
                ...
                window.innerHeight - e - 20 < i ? (H.addClass(t.domElement, dt.CLASS_TOO_TALL),
                t.__ul.style.height = window.innerHeight - e - 20 + "px") : (H.removeClass(t.domElement, dt.CLASS_TOO_TALL),
        ...
        remember: function() {
            ...
            S.each(Array.prototype.slice.call(arguments), function(e) {
                0 === t.__rememberedObjects.length && b(t),
        ...
        getSaveObject: function() {
            ...
            t.remembered[this.preset] = w(this)),
            t.folders = {},
            S.each(this.__folders, function(e, i) {
        ...
        saveAs: function(t) {
            this.load.remembered || (this.load.remembered = {},
            this.load.remembered[st] = w(this, !0)),
            this.load.remembered[t] = w(this),
            this.preset = t,
            _(this, t, !0),
            this.saveToLocalStorageIfPossible()
        },
            ...
            for (var r in i) {
                ...
                if (typeof i[r] !== "function") {
                    if (!(i[r]instanceof WebGLUniformLocation)) {
                        ...
                        o = t.gl.getUniform(t.program, i[r]);
                    n[r] = o
                }
            }
        };
...
class CGFcamera {
    ...
    orbit(t, e) {
        ...
        if (t == CGFcameraAxisID.X) {
            ...
            n = vec4.transformMat4(vec4.create(), i, mat4.rotate(mat4.create(), mat4.create(), e, this._up));
    ...
    zoom(t) {
        if (vec4.distance(this.position, this.target) > t)
            vec4.add(this.position, this.position, vec4.scale(vec4.create(), this.direction, t));
        else
...
class CGFcameraOrtho {
    ...
    zoom(t) {
        if (vec4.distance(this.position, this.target) > t)
            ...
            console.warn("CGFcameraOrtho: zoom exceeds target position, ignoring request.")
    }
    setUp(t) {
        this._up = t
    }
...
class CGFXMLreader {
    ...
    open(t, e) {
        this.xmlfile = t;
        if (typeof e.onXMLReady !== "function")
        ...
        if (this.xmlhttp != null) {
                ...
                if (n.readyState == 4) {
                    if (n.status == 200) {
                        ...
                        if (i.xmlDoc.getElementsByTagName("parseerror")) {
                            if (typeof e.onXMLError === "function")
                                e.onXMLMinorError("File " + t + " has errors.")
                        }
                        if (typeof e.onXMLReady === "function")
                            e.onXMLReady();
                        if (i.getErrorMessage() != null) {
                            if (typeof e.onXMLError === "function")
                                e.onXMLError(i.getErrorMessage());
                            return
                        }
                    } else {
                        if (typeof e.onXMLError === "function")
                            e.onXMLError(n.status + ": " + i.xmlfile + ", " + n.statusText)
                    }
                }
            }
            ;
            this.xmlhttp.onerror = function(t) {
                if (typeof e.onXMLError === "function")
                    e.onXMLError("[CGFXMLreader] Error", n.statusText)
            }
            ;
            ...
            if (typeof e.onXMLError === "function")
                e.onXMLError("The XMLHttpRequest is not supported");
            return
        }
    }
    getRGBA(t, e, i) {
